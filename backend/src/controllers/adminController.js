    ...
    const users = await prisma.user.findMany({
      ...
      select: {
        ...
        callRequests: {
          ...
          select: { id: true, callType: true, status: true, createdAt: true },
...
// scheduleMeeting removed — use POST /api/bookings instead
export async function scheduleMeeting_DEPRECATED(req, res, next) {
  try {
